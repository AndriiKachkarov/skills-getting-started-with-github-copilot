document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to create the participant list for an activity
  function createParticipantsList(activityName, participants) {
    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        if (participants.length) {
          participantsSection.appendChild(createParticipantsList(name, participants));
        }
